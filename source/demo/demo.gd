...
onready var player_name := $"PlayerName/LineEdit" as LineEdit
onready var view_distance := $"Driver/CheckButton" as CheckButton
...
func _on_CheckButton_pressed():
	if get_node("Driver/CheckButton").is_pressed():
